...
training_set = train_gen.flow_from_directory('Data\\train1',
...
base = tf.keras.applications.InceptionV3(weights = 'imagenet', include_top = False, input_shape = (180, 180, 3))
...
# Start Flower client
fl.client.start_numpy_client(server_address="192.168.1.241:50051", client=CifarClient()) #schimb la server:50051