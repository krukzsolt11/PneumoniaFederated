...
training_set = train_gen.flow_from_directory('train1',
                                          target_size = (hyper_dimension,
                                                         hyper_dimension),
                                          batch_size = hyper_batch_size,
                                          class_mode = 'categorical')

test_set = val_gen.flow_from_directory('val1',
                                      target_size = (hyper_dimension,
                                                     hyper_dimension),
                                      batch_size = hyper_batch_size,
                                      class_mode = 'categorical')
...
# Start Flower client
fl.client.start_numpy_client(server_address="server:50051", client=CifarClient()) #schimb la server:50051